// ============================================================
// FrmRol.cs
// Formulario WinForms independiente del módulo Roles.
...
namespace CpLaErmita
{
    public partial class FrmRol : Form
    {
        ...
        private void Listar()
        {
            try
            {
                DataTable lista = ProfesionalCln.Listar("Roles", txtParametro.Text);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ProfesionalCln.Guardar("Roles", esNuevo ? 0 : idActual, valores);
                Listar();
        ...
        private void CambiarEstado(short estado, string accion)
        {
            ...
            try
            {
                ProfesionalCln.CambiarEstadoLogico("Roles", id, estado);
                Listar();
            }
            catch (Exception ex)
            {
        ...
        private void btnPermisos_Click(object sender, EventArgs e)
        {
            ...
            {
                Hide();
                using (var frm = new FrmPermisosRol())
                {
